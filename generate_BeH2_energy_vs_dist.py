...
def clear_vqe_results(molecules_dir,distances,dir_to_delete):
    for d in distances:
        mol_name= molecules_dir+ '/BeH2_' + '{0}'.format(round(d,1))
    ...
    for run_opt in running_options:
        if run_opt == 'statevector':
            ...
            for d in distances:
                ...
                ci_matrix_file = '{0}/CI_matrices/{1}_cimat__16.out'.format(mol_dir,mol_name)
        ...
        if run_opt == 'IBM_real':
            ...
            for d in IBM_distances:
                ...
                vqeconfig = VQEConfig(
                    ...
                    provider = 'ibm-q-research/bar-ilan-uni-1/main',
                    encoding_type='efficient',
                    simulator='',
                    ansatz_layers=3,
                    entanglement_type='circular',
