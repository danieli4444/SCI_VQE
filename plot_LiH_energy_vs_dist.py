...
def plot_results(results_file_path,output_file,error_output_file):
    ...
    plt.errorbar(distances,statevector['vqe_averaged_energy_list'],label='Noiseless statevector simulation',color='blue',fmt='o')
    ...
    single_qubit_dist = [1.5]
    single_qubit_energy = -7.875640813804037
    single_qubit_std = 0.0027180
    plt.errorbar(single_qubit_dist,single_qubit_energy,yerr=single_qubit_std,
        ecolor = 'orange',capsize=2,label='Real hardware 1-qubit (IBMQ Quito)',color='orange',fmt='*',markersize=8)
    ...
    plt.errorbar(distances,diff_statevector,yerr=statevector['vqe_averaged_energy_std_list'],
        ecolor = 'blue',capsize=2,label='Noiseless statevector simulation',color='blue',fmt='^')
    ...
    single_qubit_dist = [1.5]
    single_qubit_energy_diff = single_qubit_energy + 7.8823622868109116
...
if __name__ == "__main__":
    ...
    results_file_name = "LiH_dist_8configs_Sat Oct  8 12:18:56 2022"
